alter table public.comics alter column author_id drop not null;
...
with current_comic as (
  insert into public.comics (
    title, slug, description, tagline, cover_path, status, publication_status,
    release_date, featured, accent_color, author, genre
  )
  values (
    'Fláuzinauta',
    'flauzinauta',
...
current_issue as (
  insert into public.issues (
    comic_id, number, slug, title, description, cover_path,
